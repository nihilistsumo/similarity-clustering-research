 ...
 *
 */
public class JiangConrathSimilarity implements SimilarityFunction
{
	 ...
	 * @return JiangConrath score between two paragraphs
	 */
	...
	private static double getParaScore(ArrayList<String> list1, ArrayList<String> list2, ILexicalDatabase db)
	{
		...
		for(String w1 : list1)
			for(String w2 : list2)
				scores.add(jc.calcRelatednessOfWords(w1, w2));
