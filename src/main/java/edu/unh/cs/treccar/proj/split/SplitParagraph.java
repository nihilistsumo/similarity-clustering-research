...
public class SplitParagraph {
	...
	final String pFile = "train.test200.cbor.paragraphs";
	final String testpFile = "test.test200.cbor.paragraphs";
	...
	public void split() throws IOException, CborException{
		...
		File test = new File(testDir.getAbsolutePath()+"/"+this.testpFile);
		train.createNewFile();
		test.createNewFile();
